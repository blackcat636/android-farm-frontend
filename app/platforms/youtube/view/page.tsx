...
export default function YouTubeViewPage() {
  ...
  const handleSubmit = async (values: { videoUrl: string; country_code?: string }) => {
    try {
      ...
      await backendClient.viewYouTubePost({
  ...
  return (
    <div style={{ maxWidth: 800, margin: '0 auto', padding: 24 }}>
      ...
      <Title level={2}>
        <EyeOutlined /> View YouTube Video
      </Title>
      ...
      <Card style={{ marginTop: 24 }}>
        ...
        <Text type="secondary">
          <ul>
            <li>Enter the YouTube video URL that needs to be viewed</li>
