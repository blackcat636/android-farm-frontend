...
- **createBackendClient(token)** — повний клієнт: auth, agents, emulators, execute, history, queue, posts, social-accounts (`startSocialAccountWarmup`), account-proxies, account-bindings, sync
